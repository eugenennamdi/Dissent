...
export function ResearchPending({ thesis }: ResearchPendingProps) {
  ...
  return (
    <div className="w-full max-w-3xl mx-auto py-10 sm:py-16 px-4">
      <Card className="border-border/80 bg-card shadow-md space-y-6">
        {/* Status Header */}
        <CardHeader className="p-5 sm:p-6 pb-0 border-b border-border/40">
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 pb-5">
            ...
            <div className="flex items-center gap-3 font-mono text-xs">
              <div className="px-3 py-1.5 rounded-md bg-secondary/80 border border-border/80 text-muted-foreground flex items-center gap-1.5">
        ...
        <CardContent className="p-5 sm:p-6 pt-0 space-y-6">
          ...
          <div className="space-y-2">
            ...
            <div className="p-4 rounded-lg bg-background/90 border border-border/60 text-sm text-foreground/90 font-sans italic leading-relaxed shadow-inner">
              &ldquo;{thesis}&rdquo;
            </div>
          </div>
          ...
          <div className="space-y-3 pt-1">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5 text-xs font-mono">
              <div className="p-3.5 rounded-lg bg-background/80 border border-border/60 text-muted-foreground flex items-start gap-2.5 shadow-xs">
                <span className="text-sky-400 font-bold tabular-nums">01</span>
                <div>
              ...
              <div className="p-3.5 rounded-lg bg-background/80 border border-border/60 text-muted-foreground flex items-start gap-2.5 shadow-xs">
                <span className="text-emerald-400 font-bold tabular-nums">02</span>
                <div>
              ...
              <div className="p-3.5 rounded-lg bg-background/80 border border-border/60 text-muted-foreground flex items-start gap-2.5 shadow-xs">
                <span className="text-indigo-400 font-bold tabular-nums">04</span>
                <div>
          ...
          <div className="p-3 rounded-lg bg-background/90 border border-border/80 text-[11px] font-mono text-muted-foreground flex flex-col sm:flex-row sm:items-center justify-between gap-2">
            <div className="flex items-center gap-1.5">
              <ShieldAlert className="w-3.5 h-3.5 text-amber-400 shrink-0" />
              <span>Do not refresh the page while research is active.</span>
            </div>
            <span className="text-muted-foreground/80">Stateless route timeout: 120s</span>
          </div>
        </CardContent>
      </Card>
    </div>
